...
float ShadowCalculation(vec4 fragPosLightSpace, DirectionalLight dirLight, vec3 normal)
{
...
void main() {
    ...
    float shadow = ShadowCalculation(fs_in.FragPosLightSpace, dirLight, fs_in.Normal);
